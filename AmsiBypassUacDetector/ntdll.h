...
typedef enum _PROCESSINFOCLASS {
  ...
  ProcessIoPortHandlers,        // (kernel-mode only) // s:
  ...
  ProcessDynamicFunctionTableInformation,  // s:
                                           // PROCESS_DYNAMIC_FUNCTION_TABLE_INFORMATION
  ProcessHandleCheckingMode,      // qs: ULONG; s: 0 disables, otherwise enables
  ProcessKeepAliveCount,          // q: PROCESS_KEEPALIVE_COUNT_INFORMATION
  ProcessRevokeFileHandles,       // s: PROCESS_REVOKE_FILE_HANDLES_INFORMATION
  ProcessWorkingSetControl,       // s: PROCESS_WORKING_SET_CONTROL (requires
                                  // SeDebugPrivilege)
  ...
  ProcessMemoryExhaustion,        // s: PROCESS_MEMORY_EXHAUSTION_INFO // since
                                  // THRESHOLD
  ...
  ProcessTelemetryCoverage,  // q: TELEMETRY_COVERAGE_HEADER; s:
                             // TELEMETRY_COVERAGE_POINT
  ProcessEnclaveInformation,
  ProcessEnableReadWriteVmLogging,   // qs:
  ...
  ProcessCombineSecurityDomainsInformation,  // s:
                                             // PROCESS_COMBINE_SECURITY_DOMAINS_INFORMATION
  ProcessEnableLogging,               // qs: PROCESS_LOGGING_INFORMATION
  ProcessLeapSecondInformation,       // qs: PROCESS_LEAP_SECOND_INFORMATION
  ProcessFiberShadowStackAllocation,  // s:
                                      // PROCESS_FIBER_SHADOW_STACK_ALLOCATION_INFORMATION
                                      // // since 19H1
  ProcessFreeFiberShadowStackAllocation,  // s:
                                          // PROCESS_FREE_FIBER_SHADOW_STACK_ALLOCATION_INFORMATION
  ProcessAltSystemCallInformation,  // s: PROCESS_SYSCALL_PROVIDER_INFORMATION
                                    // // since 20H1 // 100
  ProcessDynamicEHContinuationTargets,  // s:
                                        // PROCESS_DYNAMIC_EH_CONTINUATION_TARGETS_INFORMATION
  ProcessDynamicEnforcedCetCompatibleRanges,  // s:
                                              // PROCESS_DYNAMIC_ENFORCED_ADDRESS_RANGE_INFORMATION
                                              // // since 20H2
  ProcessCreateStateChange,  // since WIN11
  ProcessApplyStateChange,
  ProcessEnableOptionalXStateFeatures,  // s: ULONG64 // optional XState feature
                                        // bitmask
  ProcessAltPrefetchParam,  // qs: OVERRIDE_PREFETCH_PARAMETER // App Launch
                            // Prefetch (ALPF) // since 22H1
...
NTSYSCALLAPI NTSTATUS NTAPI NtGetNextProcess(_In_opt_ HANDLE ProcessHandle,
